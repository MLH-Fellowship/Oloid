                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            Text(MyStrings.signupLabel,
                                style: Theme.of(context)
                                    .textTheme
                                    .headline4
                                    .copyWith(color: MyColors.white, fontFamily: 'airbnb')),
                            MySpaces.vMediumGapInBetween,
                            BuildCupertinoTextField('Email address', TextInputType.emailAddress, false),
                            MySpaces.vSmallGapInBetween,
                            BuildCupertinoTextField('Password', TextInputType.text, true),
                            MySpaces.vMediumGapInBetween,
                          ],
                        ),
                        FlatButton(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(MyStrings.orLabel, style: TextStyle(color: MyColors.white),),
                        Container(
                          color: Colors.white24,
                          width: MediaQuery.of(context).size.width/10,
                          height: MyDimens.double_1,
                    ...
                    FlatButton(
                      ...
                      child: Padding(
                        padding: EdgeInsets.symmetric(
                            ...
                            horizontal: MyDimens.double_20),
                        child: Text(
                          MyStrings.loginToAnExistingAccountLabel,
                          style:
                          Theme.of(context)
                              .textTheme.subtitle1.
                          copyWith(
